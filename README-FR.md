...
Ignore le fichier `secret_file.html` en créant un fichier `.gitignore` (clique [ici](https://git-scm.com/docs/gitignore) pour plus d'informations) et en ajoutant les instructions nécessaires.
